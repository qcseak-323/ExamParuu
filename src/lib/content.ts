...
import ai103Outline from "../../content/ai-103/outline.json";
import ai103Questions from "../../content/ai-103/questions.json";
import ai103Flashcards from "../../content/ai-103/flashcards.json";
import ai103StudyGuide from "../../content/ai-103/study-guide.json";
...
import pl400Outline from "../../content/pl-400/outline.json";
import pl400Questions from "../../content/pl-400/questions.json";
import pl400Flashcards from "../../content/pl-400/flashcards.json";
import pl400StudyGuide from "../../content/pl-400/study-guide.json";
import pl400Path from "../../content/pl-400/learning-path.json";
import pl400CaseStudies from "../../content/pl-400/case-studies.json";

import az140Outline from "../../content/az-140/outline.json";
import az140Questions from "../../content/az-140/questions.json";
import az140Flashcards from "../../content/az-140/flashcards.json";
import az140StudyGuide from "../../content/az-140/study-guide.json";
import az140Path from "../../content/az-140/learning-path.json";
import az140CaseStudies from "../../content/az-140/case-studies.json";

import az700Outline from "../../content/az-700/outline.json";
import az700Questions from "../../content/az-700/questions.json";
import az700Flashcards from "../../content/az-700/flashcards.json";
import az700StudyGuide from "../../content/az-700/study-guide.json";
import az700Path from "../../content/az-700/learning-path.json";
import az700CaseStudies from "../../content/az-700/case-studies.json";

import az802Outline from "../../content/az-802/outline.json";
import az802Questions from "../../content/az-802/questions.json";
import az802Flashcards from "../../content/az-802/flashcards.json";
import az802StudyGuide from "../../content/az-802/study-guide.json";
import az802Path from "../../content/az-802/learning-path.json";
import az802CaseStudies from "../../content/az-802/case-studies.json";

import dp300Outline from "../../content/dp-300/outline.json";
import dp300Questions from "../../content/dp-300/questions.json";
import dp300Flashcards from "../../content/dp-300/flashcards.json";
import dp300StudyGuide from "../../content/dp-300/study-guide.json";
import dp300Path from "../../content/dp-300/learning-path.json";
import dp300CaseStudies from "../../content/dp-300/case-studies.json";

import dp420Outline from "../../content/dp-420/outline.json";
import dp420Questions from "../../content/dp-420/questions.json";
import dp420Flashcards from "../../content/dp-420/flashcards.json";
import dp420StudyGuide from "../../content/dp-420/study-guide.json";
...
import dp800Outline from "../../content/dp-800/outline.json";
import dp800Questions from "../../content/dp-800/questions.json";
import dp800Flashcards from "../../content/dp-800/flashcards.json";
import dp800StudyGuide from "../../content/dp-800/study-guide.json";
...
import ab410Outline from "../../content/ab-410/outline.json";
import ab410Questions from "../../content/ab-410/questions.json";
import ab410Flashcards from "../../content/ab-410/flashcards.json";
import ab410StudyGuide from "../../content/ab-410/study-guide.json";
import ab410Path from "../../content/ab-410/learning-path.json";
import ab410CaseStudies from "../../content/ab-410/case-studies.json";

import ab620Outline from "../../content/ab-620/outline.json";
import ab620Questions from "../../content/ab-620/questions.json";
import ab620Flashcards from "../../content/ab-620/flashcards.json";
import ab620StudyGuide from "../../content/ab-620/study-guide.json";
...
import ab250Outline from "../../content/ab-250/outline.json";
import ab250Questions from "../../content/ab-250/questions.json";
import ab250Flashcards from "../../content/ab-250/flashcards.json";
import ab250StudyGuide from "../../content/ab-250/study-guide.json";
import ab250Path from "../../content/ab-250/learning-path.json";
import ab250CaseStudies from "../../content/ab-250/case-studies.json";

import ab650Outline from "../../content/ab-650/outline.json";
import ab650Questions from "../../content/ab-650/questions.json";
import ab650Flashcards from "../../content/ab-650/flashcards.json";
import ab650StudyGuide from "../../content/ab-650/study-guide.json";
import ab650Path from "../../content/ab-650/learning-path.json";
import ab650CaseStudies from "../../content/ab-650/case-studies.json";
...
const examRegistry: Record<string, ExamContent> = {
  ...
  "ai-103": {
    outline: ai103Outline as Outline,
    questions: ai103Questions as Question[],
    flashcards: ai103Flashcards as Flashcard[],
  ...
  "pl-400": {
    outline: pl400Outline as Outline,
    questions: pl400Questions as Question[],
    flashcards: pl400Flashcards as Flashcard[],
    studyGuide: pl400StudyGuide as StudyGuideDomain[],
    learningPath: pl400Path as ExamLearningPath,
    caseStudies: pl400CaseStudies as CaseStudy[],
  },
  "az-140": {
    outline: az140Outline as Outline,
    questions: az140Questions as Question[],
    flashcards: az140Flashcards as Flashcard[],
    studyGuide: az140StudyGuide as StudyGuideDomain[],
    learningPath: az140Path as ExamLearningPath,
    caseStudies: az140CaseStudies as CaseStudy[],
  },
  "az-700": {
    outline: az700Outline as Outline,
    questions: az700Questions as Question[],
    flashcards: az700Flashcards as Flashcard[],
    studyGuide: az700StudyGuide as StudyGuideDomain[],
    learningPath: az700Path as ExamLearningPath,
    caseStudies: az700CaseStudies as CaseStudy[],
  },
  "az-802": {
    outline: az802Outline as Outline,
    questions: az802Questions as Question[],
    flashcards: az802Flashcards as Flashcard[],
    studyGuide: az802StudyGuide as StudyGuideDomain[],
    learningPath: az802Path as ExamLearningPath,
    caseStudies: az802CaseStudies as CaseStudy[],
  },
  "dp-300": {
    outline: dp300Outline as Outline,
    questions: dp300Questions as Question[],
    flashcards: dp300Flashcards as Flashcard[],
    studyGuide: dp300StudyGuide as StudyGuideDomain[],
    learningPath: dp300Path as ExamLearningPath,
    caseStudies: dp300CaseStudies as CaseStudy[],
  },
  "dp-420": {
    outline: dp420Outline as Outline,
    questions: dp420Questions as Question[],
    flashcards: dp420Flashcards as Flashcard[],
  ...
  "dp-800": {
    outline: dp800Outline as Outline,
    questions: dp800Questions as Question[],
    flashcards: dp800Flashcards as Flashcard[],
  ...
  "ab-410": {
    outline: ab410Outline as Outline,
    questions: ab410Questions as Question[],
    flashcards: ab410Flashcards as Flashcard[],
    studyGuide: ab410StudyGuide as StudyGuideDomain[],
    learningPath: ab410Path as ExamLearningPath,
    caseStudies: ab410CaseStudies as CaseStudy[],
  },
  "ab-620": {
    outline: ab620Outline as Outline,
    questions: ab620Questions as Question[],
    flashcards: ab620Flashcards as Flashcard[],
  ...
  "ab-250": {
    outline: ab250Outline as Outline,
    questions: ab250Questions as Question[],
    flashcards: ab250Flashcards as Flashcard[],
    studyGuide: ab250StudyGuide as StudyGuideDomain[],
    learningPath: ab250Path as ExamLearningPath,
    caseStudies: ab250CaseStudies as CaseStudy[],
  },
  "ab-650": {
    outline: ab650Outline as Outline,
    questions: ab650Questions as Question[],
    flashcards: ab650Flashcards as Flashcard[],
    studyGuide: ab650StudyGuide as StudyGuideDomain[],
    learningPath: ab650Path as ExamLearningPath,
    caseStudies: ab650CaseStudies as CaseStudy[],
  },
  "pl-900": {
